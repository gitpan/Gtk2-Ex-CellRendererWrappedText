...
sub RENDER {
	...
	$cell->set( 'wrap-width',
                $cell_area->width - $cell->get( 'ypad' ) * 4 );
...
Pressing <Esc> whil in edit mode cancels the edit. Pressing <Ctrl+Enter> moves
to the next line. Pressing <Ctrl+Enter> or focusing out of the render finishes
